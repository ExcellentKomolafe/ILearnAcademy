...
export default function Card({ title, about, icon, index = 0 }) {
  return (
    ...
    >
      ...
      <div aria-hidden className="absolute -right-6 -top-6 pointer-events-none opacity-0 group-hover:opacity-30 transition-opacity">
        <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M20 10 C24 2 36 2 40 10 C44 18 36 24 30 28 C24 32 14 30 10 24 C6 18 8 12 20 10 Z" fill="rgba(255,182,193,0.08)" />
          <path d="M60 20 C64 12 76 12 80 20 C84 28 76 34 70 38 C64 42 54 40 50 34 C46 28 48 22 60 20 Z" fill="rgba(199,159,255,0.06)" />
        </svg>
      </div>
    </motion.article>
  );
